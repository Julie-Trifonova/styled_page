            ...
            <div className={s.box}>
                <div className={s.header_desktop}>
                    <div className={s.welbex_logo_and_menu}>
                        <div className={s.header_welbex_logo_and_description}>
                        ...
                        <div className={`${s.footer_section} ${s.footer_section_menu}`}>
                            ...
                            <div className={`${s.footer_section_text_container} ${s.footer_section_menu_text}`}>
                                <div className={s.footer_section_menu_text_blocks}>
                                    <div className={`${s.footer_section_menu_text_block} ${s.footer_section_menu_text_block_1}`}>
                                        <div
                                    ...
                                    <div className={`${s.footer_section_menu_text_block} ${s.footer_section_menu_text_block_2}`}>
                                        <div
