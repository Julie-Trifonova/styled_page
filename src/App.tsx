                ...
                <div className={s.footer}>
                    <div className={s.footer_sections}>
                        <div className={`${s.footer_section} ${s.footer_section_about_company}`}>
                            <div className={s.footer_section_about_company_title}>
                                О компании
                            </div>
                            <div className={s.footer_section_about_company_text}>
                                <div className={s.footer_section_about_company_text_part_1}>
                                    Партнерская программа
                                </div>
                                <div className={s.footer_section_about_company_text_part_2}>
                                    Вакансии
                                </div>
                            </div>
                        </div>
                        ...
                        <div className={`${s.footer_section} ${s.footer_section_menu}`}>
                            <div className={s.footer_section_menu_title}>
                                Меню
                            </div>
                            <div className={s.footer_section_menu_text}>
                                <div className={s.footer_section_menu_text_block_1}>
                                    <div className={s.footer_section_menu_text_block_1_text}>
                                        Расчет стоимости
                                    </div>
                                    <div className={s.footer_section_menu_text_block_1_text}>
                                        Услуги
                                ...
                                <div className={s.footer_section_menu_text_block_2}>
                                    <div className={s.footer_section_menu_text_block_2_text}>
                                        Кейсы
                                    </div>
                                    <div className={s.footer_section_menu_text_block_2_text}>
                        ...
                        <div className={`${s.footer_section} ${s.footer_section_contacts}`}>
                            <div className={s.footer_section_contacts_title}>
                                Контакты
                            </div>
                            <div className={s.footer_section_contacts_text}>
